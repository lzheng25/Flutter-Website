export default {
  ...
  colors: {
    ...
    primary: '#06e2be', // primary button and link color
    // secondary: '#2563FF', // secondary color - can be used for hover states
    secondary: '#06e2be', // secondary color - can be used for hover states
  ...
  buttons: {
    ...
    primary: {
      ...
      bg: 'primary',
      '&:hover': {
        boxShadow: 'rgba(130, 252, 232, 0.9) 0px 9px 20px -5px',
      },
    },
    whiteButton: {
      variant: 'buttons.defaultBtn',
