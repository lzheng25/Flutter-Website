  ...
  features: [
    {
      ...
      text:
        'It’s hard to find anything authentic on current apps when everyone’s having fun with trigger-happy swiping. Here at Flutter, every note is sent with intention, so you know the person is genuinely interested in getting to know you, and only you.',
      // text:
      //   'Hi',
    },
    {
    ...
    <section id="why" sx={{ variant: 'section.services' }}>
      ...
      <Container sx={styles.containerBox}>
        ...
        <Box styles={styles.thumbnail}>
          ...
          <Text pb='2rem'>
          People love love. Dating apps nowadays promise to help you find love, but most people ironically use dating apps for fun. That’s why problems like ghosting, mind games and lack of results exist.  Flutter completely upheaves the current functionalities of dating apps to help people foster relationships in the most authentic way possible by reintroducing:
          </Text>
          <Grid sx={styles.grid}>
          ...
          <Text pt="2rem">
          We believe that these two core elements are key to cultivating an authentic dating experience online while maintaining the ease of connecting people that existing apps offer. Continue to learn more about how Flutter works!
          </Text>
        </Box>
      </Container>
      </Container>
